...
Disassembler::Disassembler(Cpu *pcpu, Mmu *pmmu, QWidget *parent) :
    QWidget(parent),
...
>>>>>>> 9a26bd095dc315697edc3a0680880bcec309c3c4:instruction_viewer.cpp
    ...
    {
        opcode currOpcode = getOpcodeInfos(i);
        QString opcodes, currStringOfOpcode;
        for (int j=0; j<currOpcode.numberOfBytes; j++)
            opcodes += " " + QString::number(mmu->read_ram(i + j), 16).toUpper();
        if (i < BIOS_SIZE)
            currStringOfOpcode = QString("BOOT");
        else currStringOfOpcode = QString("ROM");
        currStringOfOpcode += QString::number(i, 16).toUpper() + "   " + opcodes + "   " + currOpcode.mnemonic.toUpper();
        ui->listWidget->addItem(currStringOfOpcode);
        i += currOpcode.numberOfBytes;
    }
    this->fillMap();
...
opcode Disassembler::getOpcodeInfos(int index)
{
    ...
    case 0x01:
    {
        currOpcode.mnemonic = "LD BC, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
    ...
    case 0x06:
    {
        currOpcode.mnemonic = "LD B, "+ QString::number(mmu->read_ram(index+1));
    ...
    case 0x08:
    {
        currOpcode.mnemonic = "LD (" + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16) + "), SP";
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0x09:
    ...
    case 0x0E:
    {
        currOpcode.mnemonic = "LD C, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x0F:
    ...
    case 0x11:
    {
        currOpcode.mnemonic = "LD DE, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0x12:
    ...
    case 0x16:
    {
        currOpcode.mnemonic = "LD D, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x17:
    ...
    case 0x1E:
    {
        currOpcode.mnemonic = "LD E, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x1F:
    ...
    case 0x21:
    {
        currOpcode.mnemonic = "LD HL, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0x22:
    ...
    case 0x26:
    {
        currOpcode.mnemonic = "LD H, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x27:
    ...
    case 0x2E:
    {
        currOpcode.mnemonic = "LD L, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x2F:
    ...
    case 0x31:
    {
        currOpcode.mnemonic = "LD SP, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0x32:
    ...
    case 0x36:
    {
        currOpcode.mnemonic = "LD (HL), " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x37:
    ...
    case 0x3E:
    {
        currOpcode.mnemonic = "LD A, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0x3F:
    ...
    case 0xC2:
    {
        currOpcode.mnemonic = "JP NZ, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xC3:
    {
        currOpcode.mnemonic = "JP " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xC4:
    {
        currOpcode.mnemonic = "CALL NZ, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xC5:
    ...
    case 0xC6:
    {
        currOpcode.mnemonic = "ADD A, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xC7:
    ...
    case 0xCA:
    {
        currOpcode.mnemonic = "JP Z, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xCB:
    ...
    case 0xCC:
    {
        currOpcode.mnemonic = "CALL Z, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xCD:
    {
        currOpcode.mnemonic = "CALL " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xCE:
    {
        currOpcode.mnemonic = "ADC A, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xCF:
    ...
    case 0xD2:
    {
        currOpcode.mnemonic = "JP NC, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xD3:
    ...
    case 0xD4:
    {
        currOpcode.mnemonic = "CALL NC, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xD5:
    ...
    case 0xD6:
    {
        currOpcode.mnemonic = "SUB " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xD7:
    ...
    case 0xDA:
    {
        currOpcode.mnemonic = "JP C, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xDB:
    ...
    case 0xDC:
    {
        currOpcode.mnemonic = "CALL C, " + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xDD:
    ...
    case 0xDE:
    {
        currOpcode.mnemonic = "SBC A, " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xDF:
    ...
    case 0xE0:
    {
        currOpcode.mnemonic = "LDH (" + QString::number((int)mmu->read_ram(index + 1), 16) + "), A";
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xE1:
    ...
    case 0xE6:
    {
        currOpcode.mnemonic = "AND " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xE7:
    ...
    case 0xEA:
    {
        currOpcode.mnemonic = "LD (" + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16) + "), A";
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xEB:
    ...
    case 0xEE:
    {
        currOpcode.mnemonic = "XOR " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xEF:
    ...
    case 0xF0:
    {
        currOpcode.mnemonic = "LDH A, (" + QString::number((int)mmu->read_ram(index + 1), 16) +")";
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xF1:
    ...
    case 0xF6:
    {
        currOpcode.mnemonic = "OR " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xF7:
    ...
    case 0xFA:
    {
        currOpcode.mnemonic = "LD A, (" + QString::number((int)mmu->read_ram(index + 2), 16) + QString::number((int)mmu->read_ram(index + 1), 16) + ")";
        currOpcode.numberOfBytes = 3;
        break;
    }
    case 0xFB:
    ...
    case 0xFE:
    {
        currOpcode.mnemonic = "CP " + QString::number((int)mmu->read_ram(index + 1), 16);
        currOpcode.numberOfBytes = 2;
        break;
    }
    case 0xFF:
...
void Disassembler::fillMap()
{
    ...
    {
        uint16_t offset = i;
        i += getOpcodeInfos(i).numberOfBytes;
        OpMap.insert(offset, k);
        k++;
    }
}
